class Text4{
    ...
    display(){
    this.greeting.html("1)Read a book for 5 minutes ");
    this.greeting.position(displayWidth/2-600,displayHeight/6);
    this.greeting2.position(displayWidth/2-600,displayHeight/3);
    this.greeting2.html("2)Listen music 5 minutes");
    this.task2.html("4)Meditate for 5 minutes");
    this.task2.position(displayWidth/2-600,displayHeight/1.5);
    this.task3.html("3)Talk to your friends for 5 minutes");
